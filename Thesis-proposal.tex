...
An already obtained experiences can be used for detection other natural phenomena like lightning strikes which could be extremely useful for work at CRREAT project which needs precise localization of atmospheric events to achieve its scientific goals. 
