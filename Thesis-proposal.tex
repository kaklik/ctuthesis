...
Pokročilé radiové systémy jsou dnes běžnou součástí některých komerčních zařízení. Tato studie se zabývá využitím těchto poznatků a technologií k řešení některých vědeckých problémů. 
\end{abstract-czech}

% Abstract in English
\begin{abstract-english}
Advanced radio systems a the standard part of some commercial devices. This thesis deals with the use of resulting technology to solve some scientific problems.
