...
Radio direction finding is the oldest radio localization method.  It uses receiver system sensitive to the angular orientation of the incoming signal.  The target is localized by 
...
Every radio illuminated meteor trajectory in the atmosphere create its Doppler shift reflection footprint.  This process could be described by a numerical model of Doppler shifts for points at the trajectory. For simplicity, the presented model expects constant velocity along a straight line of the meteor path which is divided into equidistant time samples. A numerical difference of path distances between transmitter, meteor and receiver is calculated. Then velocity and Doppler shift value are obtained for every point of the trajectory. 
...
\bibitem{LOFAR}
K. Mikhailov, J. van Leeuwen, The LOFAR search for radio pulsars and fast transients in M33, M81 & M82,Astrophysics of Galaxies, A&A 593, A21 (2016), DOI: 10.1051/0004-6361/201628348
